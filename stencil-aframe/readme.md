...
Unfortunately A-Frame does not bind with Stencil Web Components either, which is what this PoC shows.  
...
What I want to happen is that I bind the position (in \src\components\my-component\my-component.tsx) of a blue `<a-box>`, but by trying that the box doens't show at all.

You can read more on my attempt to get A-Freame working with angular here: 
[Dependency management in Angular CLI - Lib: A-Frame](https://rasor.github.io/dependency-management-in-angular-cli-lib-a-frame.html)
